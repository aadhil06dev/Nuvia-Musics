 ...
 * Copyright (C) 2026 Kushagra Singh (NUViA adaptation)
 *
 * Orchard's original source is licensed under the GNU Affero General Public
 * License, version 3 or later. Per AGPLv3 section 13, this file is combined
 * here into NUViA -- a work licensed under the GNU General Public
...
Java_com_music_nuvia_playback_smart_VocalSpectrogram_nativeCompute(
    JNIEnv* env,
    jclass /* clazz */,
    jfloatArray left,
    jfloatArray right,
  ...
  const nuvia::smart::VocalSpectrogram spectrogram =
      nuvia::smart::ComputeVocalSpectrogram(channels, sample_rate);
...
Java_com_music_nuvia_playback_smart_VocalSpectrogram_nativeBins(
    JNIEnv* /* env */, jclass /* clazz */) {
  return static_cast<jint>(nuvia::smart::kVocalSpectrogramBins);
}

JNIEXPORT jdouble JNICALL
Java_com_music_nuvia_playback_smart_VocalSpectrogram_nativeSampleRate(
    JNIEnv* /* env */, jclass /* clazz */) {
  return nuvia::smart::kVocalSpectrogramSampleRate;
}

JNIEXPORT jint JNICALL
Java_com_music_nuvia_playback_smart_VocalSpectrogram_nativeHop(
    JNIEnv* /* env */, jclass /* clazz */) {
  return static_cast<jint>(nuvia::smart::kVocalSpectrogramHop);
}

JNIEXPORT jint JNICALL
Java_com_music_nuvia_playback_smart_VocalSpectrogram_nativeFftSize(
    JNIEnv* /* env */, jclass /* clazz */) {
  return static_cast<jint>(nuvia::smart::kVocalSpectrogramFft);
}
