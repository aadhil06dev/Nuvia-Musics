...
import com.music.nuvia.data.settings.SmartAnalysis
import com.music.nuvia.data.settings.TrackAnalysisState
import com.music.nuvia.data.settings.TransitionWindow
...
class CrossfadeController(
     ...
     * makes a plan's
     * [com.music.nuvia.playback.smart.TransitionPlan.transitionStyle] audible
    ...
    /**
     * The style fields of a [com.music.nuvia.playback.smart.TransitionPlan],
     ...
     * ([com.music.nuvia.playback.smart.TransitionPlan.incomingCueTime]),
     * and the tempo-stretch to align it with the outgoing track
     * ([com.music.nuvia.playback.smart.TransitionPlan.incomingPlaybackRate])
     * — see [driveLap], which applies both at the handoff — and the style the
     * blend is rendered in
     * ([com.music.nuvia.playback.smart.TransitionPlan.transitionStyle]),
     ...
     * [com.music.nuvia.playback.smart.TrackAnalyzer.request] as the next
    ...
    /** NUViA doesn't carry album metadata on [MediaMetadata] yet, so [TransitionTrackInfo.album] stays blank. */
