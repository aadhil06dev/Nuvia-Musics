...
object AudioCache {
     ...
     * [StreamResolver][com.music.nuvia.data.innertube.StreamResolver]'s
    ...
    /** Total disk bytes currently held by the cache. */
    fun currentSizeBytes(): Long = if (::cache.isInitialized) cache.cacheSpace else 0L
     ...
     * [PlaybackService][com.music.nuvia.playback.PlaybackService]'s audition.
