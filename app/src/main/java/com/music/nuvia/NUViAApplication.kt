...
import com.music.nuvia.data.canvas.CanvasCache
...
class NUViAApplication : Application(), SingletonImageLoader.Factory {
    ...
    override fun onCreate() {
        ...
        Downloads.init(this)
        com.music.nuvia.data.playlist.LocalPlaylistStore.init(this)
        com.music.nuvia.data.history.LocalHistoryStore.init(this)
        com.music.nuvia.data.stats.ListeningStats.init(this)
        com.music.nuvia.data.stats.ArtistFacts.init(this)
        com.music.nuvia.data.listentogether.ListenTogether.init(this)
        com.music.nuvia.data.canvas.SpotifyToken.init(this)
        ...
        com.music.nuvia.data.artist.ArtistFactsRepository.initialize(this)
