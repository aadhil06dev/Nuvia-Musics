 ...
 *    the same finding [ChunkedDataSource][com.music.nuvia.playback.ChunkedDataSource]
 *    exists for.
...
object Downloader {
     ...
     *    URL — see [SourceStream.headers][com.music.nuvia.data.sources.SourceStream.headers]
