 ...
 *
 * The same lookup the player does — [LyricsRepository], the same lyric
 * databases, the same user's pick of which of them may be asked — turned into
 * the string [MediaTagger] can hand a container. A download is the moment
...
object LyricsTag {
     ...
     * [toEnhancedLrc][com.music.nuvia.data.lyrics.toEnhancedLrc] for why
    ...
    suspend fun forTrack(track: Song): Embeddable? {
        ...
        // Three of the sources match on the track's length, and LRCLIB
