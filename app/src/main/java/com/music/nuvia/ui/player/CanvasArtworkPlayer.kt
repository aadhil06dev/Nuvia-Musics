...
fun CanvasArtworkPlayer(
     ...
     * [CanvasSource.SPOTIFY][com.music.nuvia.data.canvas.CanvasSource.SPOTIFY]
            ...
            val texture = TextureView(viewContext).apply {
                ...
                surfaceTextureListener = object : TextureView.SurfaceTextureListener {
                    ...
                    override fun onSurfaceTextureDestroyed(surface: SurfaceTexture): Boolean {
                        // The surface going away means the activity is leaving the
                        // screen: whatever comes next is a replacement.
                        replacing = true
