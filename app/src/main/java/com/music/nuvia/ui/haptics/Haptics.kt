package com.music.nuvia.ui.haptics
...
private class HapticDevice private constructor(
    ...
    fun play(haptic: Haptic) {
        ...
        try {
            ...
            // Gracefully no-op if vibration permission is missing or restricted by policy.
        }
    }
    ...
    companion object {
        ...
        private fun probe(app: Context): HapticDevice? {
            val hasPermission = try {
                app.checkSelfPermission(Manifest.permission.VIBRATE) ==
