 ...
 * [StreamResolver][com.music.nuvia.data.innertube.StreamResolver]. Sources
...
data class SourceStream(
     ...
     * [QualityUpgrade][com.music.nuvia.playback.QualityUpgrade].
     */
     ...
     * see [QualityUpgrade][com.music.nuvia.playback.QualityUpgrade.lookAgain].
 ...
 * [AppSettings][com.music.nuvia.data.settings.AppSettings] and is turned
