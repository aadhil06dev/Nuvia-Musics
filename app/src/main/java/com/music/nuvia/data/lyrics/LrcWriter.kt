 ...
 * `com.music.nuvia.download.LyricsTag`), and LRC is what that field is read
 ...
 * atom, where every other player looks, and this to a NUViA-specific one
 ...
 */
internal const val WORD_LYRICS_FIELD = "NUVIA_LYRICS"
