package com.music.nuvia.data.sources.module
 ...
 *
 * Ported from Convx's `ModuleManager`, adapted to use NUViA's shared
...
class ModuleManager {
     ...
     *
     * Concurrent because [ModuleSource.search][com.music.nuvia.data.sources.ModuleSource.search]
