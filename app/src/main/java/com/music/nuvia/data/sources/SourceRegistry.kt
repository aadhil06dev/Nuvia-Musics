...
/**
 * The user's sources, always tried in a fixed order: custom module first,
 * built-in module second, JioSaavn third, YouTube Music fourth.
 *
...
object SourceRegistry {
     ...
     *
     * Packed into the existing [Song.videoId][com.music.nuvia.data.model.Song.videoId]
