...
object TtmlLyrics {
    ...
    /**
     * Roles that are not part of the song's audio at all. Translations and
     * romanisations are alternate renderings of the same line and would double
     * it up.
     */
    private val SKIPPED_ROLES = setOf("x-translation", "x-roman")

    /**
     * Apple's marker for an answering vocal.
     *
     * The words inside it start partway through the lead and regularly run past
     * the *next* line's stamp, so it is collected apart
