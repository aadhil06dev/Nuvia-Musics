package com.music.nuvia.data.model
...
data class Song(
     ...
     * that need it — see [com.music.nuvia.playback.toMediaItem].
     */
...
/**
 * Parses [durationText] (e.g. "3:45" or "1:02:30") into milliseconds.
 * Returns 0L if durationText is null or unparseable.
 */
fun Song.durationMillis(): Long {
    val text = durationText ?: return 0L
...
enum class BrowseType(val label: String? = null, val noun: String = "") {
    ALBUM("Album", "album"),
...
data class DetailPage(
     ...
     * added — see [com.music.nuvia.data.innertube.InnertubeParser.parsePlaylistShelf].
    ...
    /** Enriched artist facts and metadata, populated asynchronously for artist pages. */
    val artistFacts: UiState<com.music.nuvia.data.artist.ArtistFacts>? = null,
)
...
data class ArtistPage(
    ...
    /** Verified artist biography or description from YouTube Music. */
    val description: String? = null,
    /** Subtitle or subscriber counter from YouTube Music. */
