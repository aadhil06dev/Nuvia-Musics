...
object NerdStats {
     ...
     * [QualityUpgrade.adoptUnresolved][com.music.nuvia.playback.QualityUpgrade.adoptUnresolved].
     ...
     * [PlaybackService][com.music.nuvia.playback.PlaybackService]'s
    ...
    fun declaredFormat(mediaId: String?): StreamFormat? {
        ...
        return declared[key]
            ?: com.music.nuvia.data.sources.SourceRegistry.parseTrackKey(key)
     ...
     * [PlaybackService][com.music.nuvia.playback.PlaybackService] — which the
     ...
     *
     * @see com.music.nuvia.playback.QualityUpgrade.forgetLastSession for the
